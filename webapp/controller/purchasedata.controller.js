sap.ui.define([
    ...
    return Controller.extend("luxasia.controller.purchasedata", {
        ...
        onAfterRendering: function () {
            ...
            var plant = new Filter("StoreId", "EQ", this.sStoreId);
            var email = new Filter("CreatedByEmail", "EQ", UserEmail);
            this.handlePurchaseData([plant, email]);
            console.log(this.sStoreId);
             
        },
 
        handlePurchaseData: function (filters) {
            var oList = this.getView().byId("purchaseOrderList");
            var oFilters = filters ? filters : [];
        ...
        //     if(this.getView().byId("detailitem").getItems().length == 0 && window.location.hash.indexOf("purchasedata") != (-1)){
        //         this.getView().byId("edit").setVisible(false);
        //         this.getView().byId("gr").setVisible(false);
        //     }else{
        //         this.getView().byId("edit").setVisible(true);
        //         this.getView().byId("gr").setVisible(true);
        //     }
        // },
        // 
        //
